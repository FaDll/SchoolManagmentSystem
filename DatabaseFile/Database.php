...
class Database{
    ...
    public static function getInstance(){
        if(self::$instance == NULL){
            $db = new Database("localhost", "id8877866_root", "123456789", "id8877866_school");
        }
    ...
    function selectWhere_NoIsDeleted($tableName , $condition){
    ...
    function update($tableName, $fieldsName , $data){
        ...
        $sql = "update ".$tableName." set ".$sqlConcat.", LastUpdated= 'NOW()' where ID= ".$data[0].""; 
        //echo "Sql = ".$sql;
    ...
    function Count($tableName , $condition){
        $sql = "select Count(*) from ".$tableName." where ".$condition." and IsDeleted = 0";
        $result = mysqli_query($this->conn, $sql);
        //echo $sql;
